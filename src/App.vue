<template>
  <div id="app">
    <div style="margin-top: 20px"><img alt="Vue logo" class="imglogo" src="./assets/dataon-play.png"></div>
    <div class="groupbuttons">
      <b-button-group>
        ...
        <b-button to="/atendimento" style="color:#ffffff;" variant="outline-dark"><img class="icons" src="./assets/petshop.png"/> Atendimento</b-button>
        <b-button to="/vendas" style="color:#ffffff;" variant="outline-dark"><img class="icons" src="./assets/caixa1.png"/> Vendas</b-button>
        ...
        <b-button v-show="visible" to="/estoque" style="color:#ffffff;" variant="outline-dark"><img class="icons" src="./assets/estoque.png"/> Estoque</b-button>
        ...
        <b-button v-show="visible" to="/teste" style="color:#ffffff;" variant="outline-dark"><img class="icons" src="./assets/utilitarios.png"/> Teste</b-button>
        <b-button v-show="visible"  style="color:#ffffff;" variant="outline-dark">Minha DataOn</b-button>
      </b-button-group>
    </div>
    <div id="nav">
